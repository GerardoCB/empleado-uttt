...
class EmpleadosTest < ApplicationSystemTestCase
  ...
  test "creating a Empleado" do
    ...
    fill_in "Dtefechanacimiento", with: @empleado.dteFechaNacimiento
    fill_in "Strapellidomaterno", with: @empleado.strApellidoMaterno
    fill_in "Strapellidopaterno", with: @empleado.strApellidoPaterno
    fill_in "Strnombre", with: @empleado.strNombre
