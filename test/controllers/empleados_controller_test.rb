...
class EmpleadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post empleados_url, params: { empleado: { dteFechaNacimiento: @empleado.dteFechaNacimiento, strApellidoMaterno: @empleado.strApellidoMaterno, strApellidoPaterno: @empleado.strApellidoPaterno, strNombre: @empleado.strNombre } }
    end
  ...
  test "should update empleado" do
    patch empleado_url(@empleado), params: { empleado: { dteFechaNacimiento: @empleado.dteFechaNacimiento, strApellidoMaterno: @empleado.strApellidoMaterno, strApellidoPaterno: @empleado.strApellidoPaterno, strNombre: @empleado.strNombre } }
